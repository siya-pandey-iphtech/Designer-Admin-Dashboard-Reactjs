...
const Views = () => {
  return (
    <div className="  z-10  shadow-lg bg-white w-fit  flex flex-col p-5  ">
      <div
      ...
      <div className="flex justify-between  w-fit gap-6">
        <div className="">
          ...
          <button className=" text-xs border-2 rounded-lg  border-purple-400 w-fit px-3 py-2  text-purple-600 font-semibold mt-2 text-nowrap">
            See More
          </button>
        </div>
        <div className="">
