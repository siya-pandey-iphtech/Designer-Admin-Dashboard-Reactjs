...
const Files = () => {
  ...
  return (
    <div className=" z-10 shadow-lg bg-white w-full m-1 mt-4 flex flex-col p-5 ">
      <h1 className="">Files</h1>
      {/* Tabs  */}
      <div className="flex  text-xs p-3 pb-0   border-b border-gray-300">
        <div
          className={`mr-4   p-2 pt-0 cursor-pointer ${
        ...
        <div
          className={`mr-4 pl-0 p-2 pt-0 cursor-pointer ${
        ...
        <div
          className={`pl-0 p-2 pt-0 cursor-pointer ${
